package com.github.knightliao.disconf.web.support.utils;
...
public final class DateUtils {
    ...
    public static String formatDateString(String dateString, String format1, String format2) {
        ...
        SimpleDateFormat beforeFormat = new SimpleDateFormat(format1);
        SimpleDateFormat endFormat = new SimpleDateFormat(format2);
        try {
    ...
    public static String getTwoDay2String(String startDate, String endDate, Format format) {
        ...
        long day = 0;
        try {
            Date startDay = localFormat.parse(startDate);
            Date endDay = localFormat.parse(endDate);
